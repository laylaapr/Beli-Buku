      ...
      <div class="col-md-3">
        ...
        <div class="caption"><h4><?php echo $data['judul']; ?></h4>
          ...
          <?php if ($data['stok'] > 0) {
           ...
           ?></h5>
          <a href="index.php?page=edit&idbuku=<?php echo $data['idbuku']; ?>" 
    onClick = "return confirm('Edit <?php echo $data['judul']; ?>?')" 
     button class="btn btn-primary btn-md"> 
    <span class="glyphicon glyphicon-edit"></span> </a>
      <a href="index.php?page=hapus&delidbuku=<?php echo $data['idbuku']; ?>" 
      onClick = "return confirm('Apakah Anda ingin menghapus <?php echo $data['judul']; ?>?')" 
